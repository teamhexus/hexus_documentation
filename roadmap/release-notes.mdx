...
Apply zoom across all steps in your flow with a single click using the new Auto Zoom button.

**Ukrainian and German Language Support (🌍)**

New support for Ukrainian and German languages, including AI voiceovers for both.

**Text-Based Story Creation Workflow (✍️)**

A new workflow for creating text-based stories from your flows, with multiple templates like blog posts, product launch updates, newsletters, and social media posts.
