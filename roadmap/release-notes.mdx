...
- Click the new **Auto Zoom** button in Step Settings to automatically apply zoom across all steps in your flow.
- You can still fine-tune zoom manually for each step.  
- A new demo is embedded inside the Zoom section of the docs.

**New Languages & Voice Accents (🌍)**

- Now supporting **Ukrainian** and **German** across both translations and voiceovers.
- Voiceover accents have been expanded to provide a more personalized localized experience.
- PowerPoint Download with Video Support (📽️)
- You can now export your flows to **PowerPoint with embedded video steps**, making it perfect for client presentations or offline sharing.

**New Sharing Options (📤)**

We’ve added more flexibility in publishing:

- Copy as **HTML**, **Markdown**, or **Plain Text**
- Download as **PowerPoint**
- Download **all images**

Available for all users on **Starter plans and above**.

**Text-Based Story Generator (✍️)**

Try the new AI-powered workflow for creating product stories at [app.usehexus.com/document](https://app.usehexus.com/document)

What’s new:

- Reference **multiple Hexus flows** in one document
- Customize **tone** for each article
...
- **Flow Settings** has been renamed to **AI and Language Settings** across the platform and docs.
- Localization setup now includes a full updated language list and accent selector.
- Screenshots and embedded demos updated across the Help Center to reflect the new changes.

**Deprecated (🗑️)**

- **Themes** feature has been fully removed from the product and documentation.
...
Enhanced Video Recording Mode on Chrome Extension (🖥️)
