...
- **HTML Demos (🌍) **- Record your web applications for most realistic demos with Hexus Chrome Extension.
  - Available on **Enterprise **& **Growth **plans
  - Record any web page and adapt it for your viewers with our power HTML editor.
...
- **Automatic Speech Transcription (🎤)** - AI Speech steps now automatically transcribe audio content, simplifying voiceover editing and management.
  - Edit voiceovers by modifying text instead of re-recording
  - Quickly review and adjust speech content
  - Export transcripts for accessibility and documentation
  - Enable this feature in profile settings
