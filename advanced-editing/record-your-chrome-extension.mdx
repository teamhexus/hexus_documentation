...
While Hexus can seamlessly record most web interactions, capturing content from other browser extensions (like Apollo or similar tools) can be challenging due to certain Chrome web browser limitations. However, here are a few effective workarounds to ensure you can still capture the full context of your demos:
...
- Alternatively, record your demo separately or reuse an existing video, then convert it to an interactive flow using the Hexus AI video-to-flow converter.
- The [Hexus AI Video to Flow converter](https://app.usehexus.com/video-to-flow?tab=record) is available on https://app.usehexus.com/video-to-flow?tab=record
