...
AI Mode lets you make complex text and image edits using simple instructions.
...
The AI will work in the background and return with your modifications within seconds. It's perfect for bulk changes like data anonymization, formatting updates, or complex image transformations!
...
<Tip>
  **Prompt Tips**
  ...
  - **Image Editing** prompts work best with a narrow selection of images, we recommend image at a time while we continue to improve our AI performance
