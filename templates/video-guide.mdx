...
3. For each step, you can add **descriptions**, **visuals**, and **interactive elements** to make the instructions as clear as possible. Read more about how to edit your tour [here](https://support.hexus.ai/getting-started/editing-your-tour).


<div style={{ width:"100%" }}>
<iframe src="https://app.usehexus.com/embed/41495e3c-1366-465c-b999-d54a3ac0db78?refid=" style={{ width:"100%",height:"500px",border:"0" }} frameBorder="0" allowFullScreen title="Hexus Flow" />
